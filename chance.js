...
function printError(error) {
    return (process.stdout.istty) ? chalk.red(error) : error;
}
...
program
    ...
    .action(function(generator, args, program) {
        ...
        if (generator && chance[generator]) {
            ...
            error = chalk.red('chance: unknown generator "' + generator + '"');
        }
...
if (program.args.length < 1) {
    process.stderr.write(chalk.red('chance: you must supply a generator'));
}
